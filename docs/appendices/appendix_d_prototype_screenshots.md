...
![Learner View screenshot](screenshots/learner-view.png)
...
![Progress update screenshot](screenshots/progress-update.png)
...
![Research View recommendations screenshot](screenshots/research-view-recommendations.png)

## Figure D.5: Research View Model Comparison

Shows the model comparison metrics and NDCG@5 chart.

![Research View model comparison screenshot](screenshots/research-view-model-comparisons.png)

## Figure D.6: Custom Learner Sidebar

Shows the custom learner controls for pathway, difficulty, format, and skill levels.

![Custom learner sidebar screenshot](screenshots/custom-learner-sidebar.png)
